...
public class Statics {
    ...
    public static final int SURVEY_CONSTRAINT_MSG_CELL = 7;
    ...
    public static final int ITEMS_VALIDATION_CELL = 21;
    public static final int ITEMS_VALIDATION_ERROR_MSG_CELL = 22;
